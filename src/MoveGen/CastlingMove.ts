    ...
    constructor(right: CastlingRight) {
        ...
        switch(right)
        {
            case CastlingRight.K:
                this.move = new BitMove(Square.e1, Square.g1, Piece.WhiteKing, 0, MoveType.CastleShort)
            ...
            case CastlingRight.Q:
                this.move = new BitMove(Square.e1, Square.c1, Piece.WhiteKing, 0, MoveType.CastleLong)
                this.rookSquares = [Square.a1, Square.d1]
                this.emptySquares = [Square.d1, Square.c1, Square.b1]
                this.safeSquares = [Square.e1, Square.d1]
                break
            case CastlingRight.k:
                this.move = new BitMove(Square.e8, Square.g8, Piece.BlackKing, 0, MoveType.CastleShort)
            ...
            case CastlingRight.q:
            default:
                this.move = new BitMove(Square.e8, Square.c8, Piece.BlackKing, 0, MoveType.CastleLong)
