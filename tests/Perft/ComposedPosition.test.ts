...
const position = PerftPosition.composedPosition()

// TODO: over counting nodes at depth 5, should debug with a smarter engine
const maxDepth = 4
for(let depth=1;depth <= maxDepth; depth++){
    Deno.test(`it passes composed position: ${depth}`, () => {
