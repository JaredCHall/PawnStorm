...
describe("Game", () => {
    ...
    it('makes moves and un-does them', () => {
        const game = new Game()
        game.makeMove('e4')
        game.undoMove()
    ...
    it('goes to previous move and makes a variation', () => {
        const game = new Game()
...
`)
    ...
    it('plays game in coordinate notation', () => {
    ...
    it('plays game with time limit', () => {
        using clock = new FakeTime(0)
        const game = new Game()
        game.setTimeLimit(60)
        game.startClock()
        clock.tick(5000) // white thinks for 5 seconds (55 remaining)
        game.makeMove('e2e4', 'coordinate')
        clock.tick(10000) // black thinks for 10 seconds (50 remaining)
        game.makeMove('e7e5', 'coordinate')
        clock.tick(2000) // white considers resignation (53 remaining)
...
1. e4 { [%clk 00:00:55] } e5 { [%clk 00:00:50] } *
`)


    })

    it('gets candidate moves', () => {
    ...
    it('handles stalemate with no legal moves', () => {
    ...
    it('handles draw by fifty move rule', () => {
    ...
    it('handles draw by three fold repetition', () => {
    ...
    it('handles draw by three fold repetition after switching to new line', () => {
        const game = new Game('rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2')
        game.makeMove('Ke2')
        game.makeMove('Ke7') // first - repetition starts here because castle rights have finished changing
        game.makeMove('Ke1')
    ...
    it('loads new game from Pgn File Content', () => {
